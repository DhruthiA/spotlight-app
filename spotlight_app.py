...
# ---------------------------------
# Priority: 1. Environment variable, 2. Streamlit secrets, 3. Hardcoded (fallback)
def get_api_key():
    """Get API key from environment variable, Streamlit secrets, or fallback to hardcoded."""
    ...
    return "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"
